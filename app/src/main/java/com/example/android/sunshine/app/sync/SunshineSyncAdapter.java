...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private void updateWearable(double high, double low, int weatherId) {
        ...
        //Push data to wearable. Add optional success/failure callbacks.
        Log.i(LOG_TAG,"Updating wearable: high = " + high + " low = " + low);
        Wearable.DataApi.putDataItem(mGoogleApiClient, request)
                .setResultCallback(new ResultCallback<DataApi.DataItemResult>() {
                    @Override
                    public void onResult(DataApi.DataItemResult dataItemResult) {
                        if (!dataItemResult.getStatus().isSuccess()) {
                            Log.d(LOG_TAG, "ERROR sending weather info to wearable");
                        } else {
                            Log.d(LOG_TAG, "SUCCESSFULLY sent weather data to wearable");
                        }
                    }
                });
    }
    ...
    public static Account getSyncAccount(Context context) {
         ...
         */
            if (!accountManager.addAccountExplicitly(newAccount, "", null)) {
                Log.d(LOG_TAG,"getSyncAccount no password - adding account with no password");
                return null;
            }
            /*
